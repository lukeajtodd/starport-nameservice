...
export class MsgClientImpl {
    ...
    BuyName(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.nameservice.nameservice.Msg", "BuyName", data);
        return promise.then((data) => MsgBuyNameResponse.decode(new Reader(data)));
    }
    SetName(request) {
        const data = MsgSetName.encode(request).finish();
        const promise = this.rpc.request("lukeajtodd.nameservice.nameservice.Msg", "SetName", data);
        return promise.then((data) => MsgSetNameResponse.decode(new Reader(data)));
    }
    DeleteName(request) {
        const data = MsgDeleteName.encode(request).finish();
        const promise = this.rpc.request("lukeajtodd.nameservice.nameservice.Msg", "DeleteName", data);
