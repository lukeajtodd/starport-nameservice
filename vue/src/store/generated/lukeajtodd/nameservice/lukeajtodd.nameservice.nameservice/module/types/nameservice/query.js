...
export const protobufPackage = "lukeajtodd.nameservice.nameservice";
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.nameservice.nameservice.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Whois(request) {
        const data = QueryGetWhoisRequest.encode(request).finish();
        const promise = this.rpc.request("lukeajtodd.nameservice.nameservice.Query", "Whois", data);
    ...
    WhoisAll(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.nameservice.nameservice.Query", "WhoisAll", data);
